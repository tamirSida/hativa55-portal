export const ISRAELI_CITIES = [
  // גוש דן ומרכז
  'תל אביב יפו', 'רמת גן', 'בני ברק', 'גבעתיים', 'חולון', 'בת ים', 'ראשון לציון', 'רחובות', 'נס ציונה', 'רמלה', 'לוד', 'יבנה', 'גדרה', 'פתח תקווה', 'הוד השרון', 'רעננה', 'הרצליה', 'רמת השרון', 'כפר סבא', 'ראש העין',
  
  // השרון וחוף השרון  
  'נתניה', 'חדרה', 'זכרון יעקב', 'אבן יהודה', 'קדימה צורן', 'כפר יונה', 'פרדס חנה כרכור', 'אור עקיבא', 'בנימינה גבעת עדה', 'קיסריה', 'ג׳לג׳וליה', 'עין סיני', 'ארסוף',
  
  // ירושלים והסביבה
  'ירושלים', 'בית שמש', 'מודיעין מכבים רעות', 'מודיעין', 'מעלה אדומים', 'גבעת זאב', 'מצפה יריחו', 'אור יהודה',
  
  // השפלה
  'אשקלון', 'אשדוד', 'קרית גת', 'קרית מלאכי', 'נתיבות', 'שדרות', 'אופקים', 'בית אלעזרי', 'כפר ז׳יטומיר',
  
  // באר שבע והדרום
  'באר שבע', 'דימונה', 'ערד', 'אילת', 'מצפה רמון', 'יערים', 'ירוחם', 'לקיה', 'רהט', 'תל שבע', 'ארבע', 'מעגלים', 'כסיפה', 'שפיר', 'מיתר',
  
  // חיפה והקריות
  'חיפה', 'קרית אתא', 'קרית ים', 'קרית מוצקין', 'קרית ביאליק', 'נשר', 'טירת כרמל', 'דליה', 'חוף הכרמל', 'כפר חסידים', 'קרית טבעון',
  
  // הצפון
  'נהריה', 'עכו', 'נצרת', 'עפולה', 'צפת', 'בית שאן', 'טבריה', 'קריית שמונה', 'מעלות תרשיחא', 'יקנעם', 'מגדל העמק', 'נוף הגליל', 'כרמיאל', 'אלקוש', 'מעיליא', 'מטולה', 'קצרין', 'ראש פינה', 'כפר חב׳׳ד',
  
  // ערים נוספות
  'לכיש', 'אריאל', 'מעלה אדומים', 'אלפי מנשה', 'בית אל', 'עמנואל', 'גבעת שמואל', 'איילת השחר', 'עין בוקק', 'מדרשת רופין', 'הר אדר', 'שילה', 'מיצד'
];
